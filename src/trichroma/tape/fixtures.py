...
* ``reflect3wires``, ``reflect3wires_vuv``, ``pixel_vuv``: the chroma-lar LAr
  ...
  ``chroma-lar/benchmarks/original_chroma_cases.py`` (trichroma commit 78e4b1a) for the VUV variants.
...
RUNS = {
    "synthetic": [
        ...
        # small enough to ship as test data (tests/bitwise/data/legacy_tape_tiny, legacy_tape_tiny_packed)
