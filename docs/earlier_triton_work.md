...
> `chroma.sim.Simulation` backend (see [the design](design.md) for the
> current engine). Its modules (`chroma/triton/*.py`) are at commit
> [`c951290`](https://github.com/youngsm/trichroma/tree/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton);
> its benchmark scripts, reports and the `chroma_lar.triton_scene` module
> lived in the `chroma-lar` copy, at commit
> [`78e4b1a`](https://github.com/youngsm/trichroma/tree/78e4b1ab4b64bf5be9f78d848c8490170dae8d68/chroma-lar).
> The links below point there.
...
[`scene.py`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton/scene.py) compiles Chroma's conventional flattened triangle
...
[`optics.py`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton/optics.py) converts Chroma's pointer-rich `Material` and
...
[`runtime.py`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton/runtime.py) defines CPU-only contracts between
...
[`executor.py`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton/executor.py) executes the graph through user-provided enqueue
...
- [`bvh.py`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton/bvh.py) and [`bvh_kernels.py`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton/bvh_kernels.py): packed BVH
  construction and nearest-hit traversal while preserving global triangle
  IDs and previous-hit suppression;
- [`physics.py`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton/physics.py) and
  [`physics_kernels.py`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton/physics_kernels.py): Rayleigh scattering, competing
  bulk hazards, reflection, refraction, Fresnel sampling, and deterministic
  photon generation;
- [`transport.py`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton/transport.py): device queues, compaction, and a
...
For exact differential debugging, [`rng_alignment.py`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton/rng_alignment.py) and
the matching CUDA [`rng_alignment.h`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/cuda/rng_alignment.h) define an
...
[`distributed.py`](https://github.com/youngsm/trichroma/blob/c95129023174ba0a44064889a93d72291a855fe2/src/trichroma/chroma/triton/distributed.py) implements the CPU-only process-level
